...
namespace CasgemMicroServices.Catalog.Services.CategoryServices
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<Response<CreateCategoryDto>> GetCategoryAsync(CreateCategoryDto createCategoryDto)
        {
        ...
        public async Task<Response<UpdateCategoryDto>> UpdateCategoryAsync(UpdateCategoryDto updateCategoryDto)
        {
            ...
            if (result == null)
            {
                return Response<UpdateCategoryDto>.Fail("Güncellenecek veri bbulunamadı", 404);
            }
            else
            {
