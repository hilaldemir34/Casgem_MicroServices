...
namespace Casgem_MicroServices.IdentityServer
{
    public static class Config
    {
        ...
        {
            new ApiResource ("resource_catalog"){Scopes={"catalog_fullpermission"}},//bu key katalogla ilgili işlemlere bilgi sağlayacak
            ...
            new Client[]
            {
                ...
                new Client
                {
                    ...
                    AllowedScopes={"catalog_fullpermission","photo_stock_fullpermission",
                        IdentityServerConstants.LocalApi.ScopeName },//bu clientın sahip olduğu yetkiler
                },
                ...
                new Client
                {
                    ...
                    AllowedScopes =
                    {
                        "photo_stock_fullpermission","catalog_fullpermission","basket_fullpermission","order_fullpermission",
                        "discount_fullpermission","cargo_fullpermission","payment_fullpermission",IdentityServerConstants.StandardScopes.OpenId,
